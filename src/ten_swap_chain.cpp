...
TEnSwapChain::TEnSwapChain(TEnDevice &deviceRef, VkExtent2D extent)
...
VkResult TEnSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult TEnSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex) {
...
void TEnSwapChain::createDepthResources() {
...
VkExtent2D TEnSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat TEnSwapChain::findDepthFormat() {
